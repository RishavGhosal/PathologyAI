...
function record(id: string, name: string, suggested: "Review First" | "Needs Better Image", adequate: boolean): ImageRecord {
  return {
    ...
    computed: {
      ...
      priority_score: adequate ? 0.82 : 0.18,
      summary: adequate ? "Feature variation concentrated in upper-right, high intensity (0.90)" : "Feature variation concentrated in central, high intensity (0.40)",
      source: "fixture",
      model_agreement_score: adequate ? 0.84 : null,
      model_agreement_available: adequate,
      model_agreement_method: adequate ? "Shared-grid feature-variation rank agreement" : null,
      quality_signal: { blur_score: adequate ? 120 : 8, contrast: 42 },
    },
